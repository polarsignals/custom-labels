...
static void test_basic_operations(void) {
    ...
    _hm hm;
    custom_labels_hm_init((custom_labels_hashmap_t *)&hm);
    ...
    // Test insertion
    void *old = custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, 1, &data1);
    assert(old == NULL);
    
    old = custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, 2, &data2);
    assert(old == NULL);
    
    // Test retrieval
    test_data_t *retrieved = (test_data_t *)custom_labels_hm_get((custom_labels_hashmap_t *)&hm, 1);
    assert(retrieved == &data1);
    assert(retrieved->value == 42);
    
    retrieved = (test_data_t *)custom_labels_hm_get((custom_labels_hashmap_t *)&hm, 2);
    assert(retrieved == &data2);
    assert(retrieved->value == 100);
    
    // Test update
    old = custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, 1, &data3);
    assert(old == &data1);
    
    retrieved = (test_data_t *)custom_labels_hm_get((custom_labels_hashmap_t *)&hm, 1);
    assert(retrieved == &data3);
    assert(retrieved->value == 200);
    
    // Test deletion
    old = custom_labels_hm_delete((custom_labels_hashmap_t *)&hm, 1);
    assert(old == &data3);
    ...
    old = custom_labels_hm_delete((custom_labels_hashmap_t *)&hm, 999);
    assert(old == NULL);
...
static void test_collisions(void) {
    ...
    for (int i = 0; i < 10; i++) {
        void *old = custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, i, &data[i]);
        assert(old == NULL);
    }
    
    // Verify all keys can be retrieved
    for (int i = 0; i < 10; i++) {
        test_data_t *retrieved = (test_data_t *)custom_labels_hm_get((custom_labels_hashmap_t *)&hm, i);
    ...
    for (int i = 0; i < 10; i += 2) {
        void *old = custom_labels_hm_delete((custom_labels_hashmap_t *)&hm, i);
        assert(old == &data[i]);
    }
...
static void test_rehashing(void) {
    ...
    for (int i = 0; i < 20; i++) {
        void *old = custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, i + 1000, &data[i]);
        assert(old == NULL);
    }
    
    // Verify all elements are still accessible after rehashing
    for (int i = 0; i < 20; i++) {
        test_data_t *retrieved = (test_data_t *)custom_labels_hm_get((custom_labels_hashmap_t *)&hm, i + 1000);
        assert(retrieved == &data[i]);
    ...
    for (int i = 0; i < 10; i++) {
        void *old = custom_labels_hm_delete((custom_labels_hashmap_t *)&hm, i + 1000);
        assert(old == &data[i]);
    }
...
static void test_deletion_edge_cases(void) {
    ...
    custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, key1, &data1);
    custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, key2, &data2);
    custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, key3, &data3);
    custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, key4, &data4);
    
    // Delete middle element
    void *old = custom_labels_hm_delete((custom_labels_hashmap_t *)&hm, key2);
    assert(old == &data2);
    
    // Verify remaining elements are still accessible
    assert(custom_labels_hm_get((custom_labels_hashmap_t *)&hm, key1) == &data1);
    assert(custom_labels_hm_get((custom_labels_hashmap_t *)&hm, key2) == NULL);
    assert(custom_labels_hm_get((custom_labels_hashmap_t *)&hm, key3) == &data3);
    assert(custom_labels_hm_get((custom_labels_hashmap_t *)&hm, key4) == &data4);
    
    // Delete first element
    old = custom_labels_hm_delete((custom_labels_hashmap_t *)&hm, key1);
    assert(old == &data1);
    
    // Verify remaining elements
    assert(custom_labels_hm_get((custom_labels_hashmap_t *)&hm, key1) == NULL);
    assert(custom_labels_hm_get((custom_labels_hashmap_t *)&hm, key3) == &data3);
    assert(custom_labels_hm_get((custom_labels_hashmap_t *)&hm, key4) == &data4);
...
static void test_large_keys(void) {
    ...
    custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, large_key1, &data1);
    custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, large_key2, &data2);
    
    test_data_t *retrieved1 = (test_data_t *)custom_labels_hm_get((custom_labels_hashmap_t *)&hm, large_key1);
    test_data_t *retrieved2 = (test_data_t *)custom_labels_hm_get((custom_labels_hashmap_t *)&hm, large_key2);
...
static void sanity_check_hashmap(_hm *hm) {
    ...
    for (uint64_t i = 0; i < capacity; i++) {
        ...
        if (bucket->value != NULL) {
            ...
            void *found = custom_labels_hm_get((custom_labels_hashmap_t *)hm, bucket->key);
    ...
    for (int round = 0; round < 50000; round++) {
        ...
        if (operation < 60 && num_active_keys < MAX_KEYS) {
            ...
            if (!key_exists) {
                ...
                void *old = custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, new_key, &test_data[data_index]);
                assert(old == NULL);
            ...
            void *old = custom_labels_hm_delete((custom_labels_hashmap_t *)&hm, key_to_delete);
            assert(old != NULL);
            ...
            int data_index = rand() % TEST_DATA_SIZE;
            void *old = custom_labels_hm_insert((custom_labels_hashmap_t *)&hm, key_to_update, &test_data[data_index]);
            assert(old != NULL);
        }
        ...
        for (int i = 0; i < num_active_keys; i++) {
          void *found = custom_labels_hm_get((custom_labels_hashmap_t *)&hm, active_keys[i]);
          if (found == NULL) {
